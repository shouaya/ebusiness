...
LOCK TABLES `T_BankInfo` WRITE;
/*!40000 ALTER TABLE `T_BankInfo` DISABLE KEYS */;
INSERT INTO `T_BankInfo` VALUES (1,1,'XXX銀行','0000','XX支店','111','１１１１１１１','普通','カ）イー　ビジネス'),(2,1,'XXX銀行','0000','XX支店','111','１１１１１１１','普通','カ）イー　ビジネス');
...
LOCK TABLES `T_CodeMaster` WRITE;
...
LOCK TABLES `T_ContractDetail` WRITE;
...
LOCK TABLES `T_Estimation` WRITE;
...
LOCK TABLES `T_EstimationDetail` WRITE;
...
LOCK TABLES `T_ManagementBook` WRITE;
...
LOCK TABLES `T_PcCodeMaster` WRITE;
...
LOCK TABLES `T_SaleAttatchment` WRITE;
...
LOCK TABLES `T_SaleDetail` WRITE;
...
LOCK TABLES `eb_clientmember` WRITE;
...
LOCK TABLES `eb_projectactivity` WRITE;
...
LOCK TABLES `eb_projectactivity_client_members` WRITE;
...
LOCK TABLES `eb_projectactivity_members` WRITE;
...
LOCK TABLES `eb_projectactivity_salesperson` WRITE;
...
LOCK TABLES `eb_projectmember` WRITE;
...
LOCK TABLES `eb_projectskill` WRITE;
...
LOCK TABLES `eb_projectstatus` WRITE;
...
LOCK TABLES `eb_salesperson` WRITE;
...
-- Dump completed on 2015-09-09  2:16:56
